...
{ 
			...
			case EBAT_LightAttack :
			{
				...
				switch ( stage )
				{
					case BS_Pressed :
					{
							...
							// RPO - BEGIN
							if (!RPO_lightattackEntryPoint(this)) {
								return false;
							}
							// RPO - END
			...
			case  EBAT_HeavyAttack :
			{
				...
				switch ( stage )
				{
					case BS_Released :
					{
							...
							// RPO - BEGIN
							if (!RPO_heavyattackEntryPoint(this)) {
								return false;
							}
							// RPO - END
	...
	public function HasStaminaToUseSkill(skill : ESkill, optional perSec : bool, optional signHack : bool) : bool
	{
		...
		// RPO - BEGIN
		cost *= RPO_getSkillStaminaCostModifier(skill);
		// RPO - END
	...
	// RPO - BEGIN
	var RPO_animation_speed_modifier_ids: array<int>;

	function RPO_resetAnimationSpeedMultipliers() {
		if (this.RPO_animation_speed_modifier_ids.Size() > 0) {
			thePlayer.ResetAnimationSpeedMultiplier( this.RPO_animation_speed_modifier_ids[0] );
			this.RPO_animation_speed_modifier_ids.EraseFast(0);
		}
	}
	// RPO - END
	...
	event OnCombatActionEndComplete()
	{
		...
		// RPO - BEGIN
		this.RPO_resetAnimationSpeedMultipliers();
		// RPO - END
