...
@REM XCOPY "%modPath%\strings" "%gamepath%\mods\%modname%\content\" /e /s /y
@REM copy "%modPath%\mod-menu.xml" "%gamePath%\bin\config\r4game\user_config_matrix\pc\%modname%.xml" /y
